...
def submit_frequency():
    ...
    response = requests.post("http://127.0.0.1:5000/calculate_planck_energy", json={"frequency": frequency})
...
def submit_heisenberg():
    ...
    response = requests.post("http://127.0.0.1:5000/check_heisenberg", json={
